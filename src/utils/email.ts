...
import { EMAIL_SENDER, NODE_ENV, RESEND_API_KEY } from "../configs/env.config";
...
export const sendEmail = async ({ to, subject, html, text }: ResendParams) => {
